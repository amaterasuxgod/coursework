...
namespace WindowsFormsApp1 {
    ...
    public partial class DatabDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(string ФИО, string КУРС, string Телефон, string Электронная_почта, string user, string password, int Номер_карты) {
            ...
            private void InitClass() {
                ...
                this.columnНомер_карты = new global::System.Data.DataColumn("Номер карты", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public int Номер_карты {
                get {
                    try {
                        return ((int)(this[this.tableStudents.Номер_картыColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WindowsFormsApp1.DatabDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Students` WHERE ((`id` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `КУРС` IS NULL) OR (`КУРС` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)) AND ((? = 1 AND `Электронная почта` IS NULL) OR (`Электронная почта` = ?)) AND ((? = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `Номер карты` IS NULL) OR (`Номер карты` = ?)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Номер_карты", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Номер карты", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Students` (`ФИО`, `КУРС`, `Телефон`, `Электронная почта`, `user`, `p" +
                "assword`, `Номер карты`) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Номер_карты", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Номер карты", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Students` SET `ФИО` = ?, `КУРС` = ?, `Телефон` = ?, `Электронная почта` = ?, `user` = ?, `password` = ?, `Номер карты` = ? WHERE ((`id` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `КУРС` IS NULL) OR (`КУРС` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)) AND ((? = 1 AND `Электронная почта` IS NULL) OR (`Электронная почта` = ?)) AND ((? = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `Номер карты` IS NULL) OR (`Номер карты` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Номер_карты", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Номер карты", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Номер_карты", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Номер карты", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.DatabConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, ФИО, КУРС, Телефон, [Электронная почта], [user], [password], [Номер ка" +
                "рты] FROM Students";
        ...
        public virtual int Fill(DatabDataSet.StudentsDataTable dataTable) {
        ...
        public virtual DatabDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabDataSet.StudentsDataTable dataTable = new DatabDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabDataSet.StudentsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabDataSet dataSet) {
        ...
        public virtual int Delete(int Original_id, string Original_ФИО, string Original_КУРС, string Original_Телефон, string Original_Электронная_почта, string Original_user, string Original_password, global::System.Nullable<int> Original_Номер_карты) {
            ...
            if ((Original_Номер_карты.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((int)(Original_Номер_карты.Value));
            }
            else {
        ...
        public virtual int Insert(string ФИО, string КУРС, string Телефон, string Электронная_почта, string user, string password, global::System.Nullable<int> Номер_карты) {
            if ((ФИО == null)) {
            ...
            if ((Номер_карты.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((int)(Номер_карты.Value));
            }
            else {
        ...
        public virtual int Update(string ФИО, string КУРС, string Телефон, string Электронная_почта, string user, string password, global::System.Nullable<int> Номер_карты, int Original_id, string Original_ФИО, string Original_КУРС, string Original_Телефон, string Original_Электронная_почта, string Original_user, string Original_password, global::System.Nullable<int> Original_Номер_карты) {
            if ((ФИО == null)) {
            ...
            if ((Номер_карты.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Номер_карты.Value));
            }
            else {
            ...
            if ((Original_КУРС == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_КУРС));
            }
            if ((Original_Телефон == null)) {
            ...
            if ((Original_Номер_карты.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_Номер_карты.Value));
            }
            else {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(DatabDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(DatabDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(DatabDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._studentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(DatabDataSet dataSet) {
            if ((dataSet == null)) {
